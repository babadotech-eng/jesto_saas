        ...
        <section style={{ background: C.bg }} className="py-28 md:py-36 px-10 md:px-14">
          <div className="max-w-6xl mx-auto">
            <Reveal>
              ...
              <p style={{ fontSize: "1rem", lineHeight: 1.8, color: C.muted, maxWidth: 460, marginBottom: "3.5rem" }}>Seja um restaurante, pizzaria, açougue, padaria ou delivery,
              a Jesto se adapta à sua operação.</p>
            </Reveal>
            ...
            <div className="grid md:grid-cols-3 gap-5 items-end">
              ...
              <Reveal delay={80} className="flex">
                <div className="rounded-2xl px-7 py-10 flex flex-col relative w-full shadow-xl" style={{ background: "#1A1A1A", border: `2px solid ${C.accent}`, minHeight: 560 }}>
                  ...
                  <div style={{ marginBottom: "1.5rem" }}><span style={{ fontSize: "2.4rem", fontWeight: 900, color: "#fff" }}>R$ {fmt(anual ? PRICES.pro.m * 0.8 : PRICES.pro.m)}</span><span style={{ fontSize: "0.85rem", color: "rgba(255,255,255,0.4)", marginLeft: 4 }}>/mês</span>{anual && <p style={{ fontSize: "0.85rem", color: "rgba(255,255,255,0.4)", marginTop: 2 }}>cobrado anualmente.</p>}</div>
              ...
              <Reveal delay={160} className="flex">
                <div className="rounded-2xl p-7 flex flex-col w-full" style={{ background: C.surface, border: `1px solid ${C.border}`, minHeight: 520 }}>
                  ...
                  <div style={{ marginBottom: "1.5rem" }}><span style={{ fontSize: "2.4rem", fontWeight: 900, color: C.text }}>R$ {fmt(anual ? PRICES.premium.m * 0.8 : PRICES.premium.m)}</span><span style={{ fontSize: "0.85rem", color: C.muted, marginLeft: 4 }}>/mês</span>{anual && <p style={{ fontSize: "0.85rem", color: C.muted, marginTop: 2 }}>cobrado anualmente.</p>}</div>
