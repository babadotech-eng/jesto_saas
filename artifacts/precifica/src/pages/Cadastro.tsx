        ...
        <Card className="shadow-xl border-white/10 bg-[#161722]">
          <CardContent className="space-y-4 !pt-6">
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <Button type="submit" className="w-full h-11 text-base mt-2 font-semibold text-[#1A1A1A] disabled:!opacity-100" style={{ backgroundColor: '#FFDF20' }} onMouseEnter={e => (e.currentTarget.style.backgroundColor = '#FDC700')} onMouseLeave={e => (e.currentTarget.style.backgroundColor = '#FFDF20')} disabled={loading || !passwordValid(password)}>
